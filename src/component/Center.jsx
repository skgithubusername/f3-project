...
//     <div className="h-screen overflow-hidden pt-20  flex">
...
//             <div key={index} className="mb-6 w-[980px] p-4 bg-[#00366C] text-white rounded shadow-md">
...
//                   <li key={idx} className="text-md">{option}</li>
//                 ))}
//               </ul>
